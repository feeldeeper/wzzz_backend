<?php
	...
	if(isset($_GET['action']) && $_GET['action']=="login")
	{
		...
		$query = "select * from user where username='".$name."' and password='".$pwd."' and type<3 and type>0";
		// and lastlogintime<'$today'
		// echo $query;exit();	

		$result = mysql_query($query,$conn) or die("Operation mistakes!".mysql_error());
...
<head id="Head1"><title>王者至尊管理网</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<body>
 <div align="center">
    <form name="form1" method="post" onsubmit="return chkinput(this)" action="login.php?action=login" id="form1">
      ...
      <table width="1000" height="700" border="0" cellpadding="0" cellspacing="0" background="images/loginbg.jpg">
            <tr>
            ...
            <tr>
                ...
                <td height="362" width="564">
                    <table height="362" width="564" border="0" cellpadding="0" cellspacing="0" style="text-align: left;">
                        <tr>
                            <td height="39">
                                <input name="userName" type="text" id="userName" class="logintext" style="width:178px;" />
                            </td>
                        </tr>
                        <tr>
                            <td height="36">
                                <input name="password" type="password" id="passWord" class="logintext" style="width: 178px" />
                            </td>
                        </tr>
                        <tr>
                            <td height="35">
                                <input name="checkCode" type="text" id="checkCode" class="logintext" style="width:87px;" />
                                &nbsp;<img align="absmiddle" style="width:84px; height:26px" src="vcode.php" />
                            </td>
                        </tr>
                        <tr>
                            <td height="23">
                        ...
                        <tr>
                            <td height="37">
                                <input type="image" name="Button1" id="Button1" onclick="return chkinput(document.form1)" onmouseover="this.src='images/button2.jpg'" onmouseout="this.src='images/button1.jpg'" src="images/button1.jpg" style="border-width:0px;" />
                            </td>
                        </tr>
                        <tr>
                            <td height="192">
...
<map name="Map" id="Map"><area shape="rect" coords="1,1,32,22" href="#" /></map>
