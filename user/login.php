...
if (isset($_GET['action']) && $_GET['action'] == "login") {
    ...
    if ($result) {
        ...
        if (!session_is_registered("isadmin")) {
            ...
            $_SESSION['admintab'] = $result['type'];

            $date = date("Y-m-d H:i:s", time());
            $ip = get_ip();
            $query = "update user set ip='$ip',lastlogintime='$date',logintimes=logintimes+1 where id=" . $result['id'];
                        ...
                        <tr>
                            <td height="37">
                                <input type="image" name="Button1" id="Button1"
                                       ...
                                       onmouseover="this.src='images/button2.jpg'"
                                       onmouseout="this.src='images/button1.jpg'" src="images/button1.jpg"
