...
<a href='/user/report/livebalance.php'>余额统计报表</a>
<A href='/user/report/livebalance.php'></A><A href='/user/report/livebalance.php'></A></DIV>
...
function go(page){
	...
	if (userName != '') {
		var url = "/user/report/livebalance.php?userName="+$("#userName").val()+"&stime="+$("#sTime").val()+"&etime="+$("#eTime").val()+"&type=0";
	} else {
		var url = "/user/report/livebalance.php?userName="+$("#userName").val()+"&stime="+$("#sTime").val()+"&etime="+$("#eTime").val()+"&type=0";
	}
	redirect(url);
