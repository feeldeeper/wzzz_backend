...
<input type="text" name="page" id="page" size="4" onKeyDown="if(event.keyCode==13) {redirect('/user/log/notice.php?page='+this.value); return false;}"> 
<input type="button" value="转到" class="button_style" onclick="redirect('/user/log/notice.php?page='+$('#page').val())"></div></div>
</body>
</html>