...
$nid = 1;
if (isset($_GET['id']) && $_GET['id'] != "") $nid = $_GET['id'];


$notice = $database->query("select * from notice where id = $nid")->fetch();
...
<form name="myform" method="post" action="edit.php?id=<?= $nid ?>">
    <table cellpadding="0" cellspacing="1" class="table_form">
        ...
        <tr>
            ...
            <td width="80%"><select name="game">
                    <option value="所有游戏" selected="selected">所有游戏</option>
                </select>
            </td>
        </tr>
        <tr>
            <th width="20%"><strong>状态：</strong></th>
            <td width="80%"><select name="state">
                    <option value="发布中" selected="selected">发布中</option>
                </select>
            </td>
        </tr>
        <tr>
            <th width="20%"><strong>类型：</strong></th>
            <td width="80%"><select name="notype">
                    <option value="代理网公告" <?php if ($notice['type'] == "代理网公告") echo 'selected="selected"'; ?>>代理网公告
                    </option>
                    <option value="会员网公告" <?php if ($notice['type'] == "会员网公告") echo 'selected="selected"'; ?>>会员网公告
                    </option>
        ...
        <tr>
            ...
            <td width="80%"><input type="text" name="title" id="title" value="<?php echo $notice['title']; ?>"
                                   size="170" class="">
            </td>
        </tr>
        <tr>
            <th width="20%"><strong>内容：</strong></th>
            <td width="80%"><input type="text" name="content" id="content" value="<?php echo $notice['content']; ?>"
                                   size="170" class="">
            </td>
        </tr>
        <tr>
            <th width="20%"><strong>开始时间：</strong></th>
            <td width="80%"><input type="text" name="stime" id="stime" value="<?php echo $notice['stime']; ?>" size="25"
                                   class="">
            </td>
        </tr>
        <tr>
            <th width="20%"><strong>结束时间：</strong></th>
            <td width="80%"><input type="text" name="etime" id="etime" value="<?php echo $notice['etime']; ?>" size="25"
                                   class="">
            </td>
        </tr>
        <script>
