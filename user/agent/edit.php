...
<form name="myform" method="post" action="edit.php?id=<?= $id ?>">
    ...
    <table cellpadding="0" cellspacing="1" class="table_form">
        ...
        <tr>
            ...
            <td>
                <?php if ($topuser['type'] == "1") echo "总";
                echo "代理：" . $topuser['username']; ?>      </td>
        </tr>
        <tr>
            <th width="20%"><strong>用户名：</strong></th>
            <td width="80%"><?php echo $user['username']; ?>
            </td>
        </tr>
        <tr>
            <th><strong>别名：</strong></th>
            <td>
                <input type="text" name="nickName" id="nickName" value="<?php echo $user['nickName']; ?>" size="12"
                       class=""></td>
        </tr>
        <tr>
    ...
    <input type="text" name="tel" id="tel" size="16" maxlength="16" value="">        </td>
        ...
        <tr>
            ...
            <td><?php echo $user['currentmoney']; ?>
                &nbsp;<font style="color:red"></font><span id="liveMoney1"></span>
                &nbsp;&nbsp;<span id="bigLiveMoney"></td>
        </tr>
        <tr>
            <th><strong>洗码类型：</strong></th>
            <td>
                <?php if ($topuser['type'] == "1") { ?>
                    <input type="radio"
                           onclick="$('#liveWash2').html('1.8');$('#liveWash').val('1.8');$('#liveWash').attr('max','1.8');"
                           name="ximatype" <?php if ($user['danshuangbian'] == "1") echo "checked"; ?> value="1">单边
                    <input type="radio"
                           onclick="$('#liveWash2').html('0.9');$('#liveWash').val('0.9');$('#liveWash').attr('max','0.9');"
                           name="ximatype" <?php if ($user['danshuangbian'] == "0") echo "checked"; ?> value="0">双边
                <?php } elseif ($topuser['type'] == "2") { ?>
                    <?php if ($topuser['danshuangbian'] == "1") { ?><input type="radio" name="ximatype" checked
                                                                           value="1">单边<?php } ?>
                    <?php if ($topuser['danshuangbian'] == "0") { ?><input type="radio" name="ximatype" checked
                                                                           value="0">双边<?php } ?>
                <?php } ?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input boxid="auto" name="liveWash" id="liveWash" type="text" value="<?= $user['xima'] ?>" size="5"
                       maxlength="5" require="true" datatype="double|range" min="0" max="<?= $ximalimit ?>"
