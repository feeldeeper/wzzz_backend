...
<table cellpadding="0" cellspacing="1" class="table_form">
    ...
    <tr>
        ...
        <td width="80%"><input type="text" style="ime-mode:disabled" name="userName" id="userName" size="16" class=""  maxlength="20" require="true" datatype="limit|ajax" url="/user/agent/checkuser.php" min="2" max="20" msg="用户名不得少于2个字符超过20个字符|"/></td>
    </tr>
	        <tr>
