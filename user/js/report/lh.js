...
function go(page){
	...
	if (userName != '') {
		var url = "/user/report/livelh.php?key="+$("#userName").val()+"&stime="+$("#sTime").val()+"&etime="+$("#eTime").val()+"&type=1";
	} else {
		var url = "/user/report/livelh.php?stime="+$("#sTime").val()+"&etime="+$("#eTime").val()+"&type=1";
	}
	redirect(url);
}
