...
function go(page){
	...
	if (userName != '') {
		var url = "/user/report/livebjl.php?key="+$("#userName").val()+"&stime="+$("#sTime").val()+"&etime="+$("#eTime").val();
	} else {
		var url = "/user/report/livebjl.php?stime="+$("#sTime").val()+"&etime="+$("#eTime").val();
	}
	location.href = url;
}
