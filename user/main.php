...
<div id="header">
  ...
  <p id="info_bar"> 用户名称：<strong class="font_arial white">
    ...
    <?php if($_SESSION["admintab"]=="0") echo "超级管理员";elseif($_SESSION["admintab"]=="1") echo "总代理"; else echo "代理";?>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php" class="white">退出登入</a>&nbsp;&nbsp;|&nbsp;&nbsp;选择语言：
  ...
  <div id="menu">
	...
	<?php if($name=="admin1"){?> 
	  ...
	  <li><a href="online.php" onclick="get_menu(4, 'tree', 0)" id="menu_4" class="menu" target="right" alt="在线用户"><span>在线用户</span></a></li>
	  <li><a href="gamelog/bjl.php" onclick="get_menu(1, 'tree', 0)" id="menu_1" class="menu" target="right" alt="游戏记录"><span>游戏记录</span></a></li>
	  <li><a href="report/liveall.php" onclick="get_menu(2, 'tree', 0)" id="menu_2" class="menu" alt="游戏报表" target="right"><span>游戏报表</span></a></li>
	  <li><a href="agent/index.php?id=<?=$uid?>" onclick="get_menu(0, 'tree', 0)" id="menu_6" class="menu" target="right" alt="用户管理"><span>用户管理</span></a></li>
...
<div id="admin_left">
  <div id="inner" class="inner">
    <h4><em style="float:right"><img src="images/refresh.gif" onClick="javascript:menu_refresh()" width="16" height="25" id="menurefresh" alt="刷新" title="刷新" />
...
<div id="admin_right">
  <div id="inner" class="inner" style="">
	<!--導航-->
				<a href="message.php" target="right"><img id="msg_img" src="images/icon_4.gif" title="短消息" height="22" width="22" /></a>
    <span class="btn_menu">
		        <a href="javascript:show_map();show_div(this)" id="show_map" title="後臺管理地圖"><img src="images/icon_9.gif" title="後臺管理地圖" height="22" width="22" /></a>
        <a href="javascript:add_menu()" title="添加常用操作"><img src="images/icon_1.gif" title="添加常用操作" height="22" width="22" /></a>
		<a href="javascript:search_menu()"><img src="images/icon_2.gif" title="菜單搜索" height="22" width="22"  /></a>
		<a href="?mod=phpcms&file=safe&action=start" target="right" onclick="show_div(this)"><img src="images/icon_3.gif" title="掃描木馬" height="22" width="22"  /></a>
		<a href="javascript:get_memo()" onclick="show_div('memo')"><img src="images/icon_7.gif" title="備忘錄" height="22" width="22" /></a>
		<a href="javascript:help_url();show_div(this)"><img src="images/icon_6.gif" title="使用幫助，按F2也可以打開幫助" height="22" width="22"  /></a>
	</span>
	<input type="hidden" name="ismsgopen" id="ismsgopen" value="0" /> 
    <div id="new_msg"><img src="images/s.gif" alt="查看新消息" style="width:49px;height:20px;margin-right:-2px;" onclick="go_right('message/inbox.php?userid=1');" /><img src="/skin/images/close_1.gif" alt="關閉" onclick="$('#new_msg').hide();$('#ismsgopen').val('1');" style="margin:5px 15px;" /></div>
