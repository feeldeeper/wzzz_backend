...
<div id="admin_main">
  ...
  <div id="admin_main_2_2">
    ...
    <div class="bdr"><textarea name="data" id="memo_data" class="inputtext" style="height:173px;width:99%;margin:5px; padding:5px" onblur='$.post("/admin/notepad.php", { data: this.value }, function(data){$("#memo_mtime").html(data);});'><?php echo $memo;?></textarea></div>
