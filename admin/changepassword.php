...
if (isset($_POST['dosubmit']) && $_POST['dosubmit'] != "") {
    ...
    if ($result) {
        ...
        echo "<script>alert('旧密码不匹配!');history.back(-1);</script>";
        exit();
    }
}
?>
...
<form action="changepassword.php" method="post" name="myform">
    <table cellpadding="0" cellspacing="1" class="table_form">
        ...
        <tr>
            <th>原密码：</th>
            <td><input name="oldPassword" type="password" id="oldPassword" size="15" require="true" datatype="limit"
                       min="6" max="16" msg="密码不得少于6个字符或超过16个字符！"/></td>
        </tr>
        <tr>
            <th>新密码：</th>
            <td><input name="newPassword" type="password" id="newPassword" size="20" require="true" datatype="limit"
                       min="6" max="16" msg="密码不得少于6个字符或超过16个字符！"/></td>
        </tr>
        <tr>
            <th>密码强度：</th>
            <td>
                <div id="pw_check_1" class="pw_check" style="display:;"><span><strong class="c_orange">弱</strong></span><span>中</span><span>强</span>
                </div>
                <div id="pw_check_2" class="pw_check" style="display:none;"><span>弱</span><span><strong
                            class="c_orange">中</strong></span><span>强</span></div>
                <div id="pw_check_3" class="pw_check" style="display:none;"><span>弱</span><span>中</span><span><strong
                            class="c_orange">强</strong></span></div>
            </td>
        </tr>
        <tr>
            <th>确认新密码：</th>
            <td><input name="chkPassword" type="password" id="chkPassword" size="20" require="true"
                       datatype="limit|repeat" min="6" max="16" to="newPassword" msg="密码不得少于6个字符或超过16个字符|两次输入的密码不一致"/>
            </td>
        </tr>
        <tr>
