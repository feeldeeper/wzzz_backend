...
<body>
 <div align="center">
    <form name="form1" method="post" onsubmit="return chkinput(this)" action="login.php?action=login" id="form1">
      ...
      <table width="1000" height="700" border="0" cellpadding="0" cellspacing="0" background="../user/images/loginbg.jpg">
            <tr>
            ...
            <tr>
                ...
                <td height="362" width="564">
                    <table height="362" width="564" border="0" cellpadding="0" cellspacing="0" style="text-align: left;">
                        ...
                        <tr>
                            <td height="37">
                                <input type="image" name="Button1" id="Button1" onclick="return chkinput(document.form1)" onmouseover="this.src='../user/images/button2.jpg'" onmouseout="this.src='../user/images/button1.jpg'" src="../user/images/button1.jpg" style="border-width:0px;" />
                            </td>
                        </tr>
                        <tr>
                            <td height="192">
