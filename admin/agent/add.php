...
<table cellpadding="0" cellspacing="1" class="table_form">
	<caption>添加 总代理 账号</caption>

    <tr>
  		<th width="20%"><strong>用户名：</strong></th>
        <td width="80%">
<input type="text" style="ime-mode:disabled" name="userName" id="userName" size="16" class=""  maxlength="20" require="true" datatype="limit|ajax" url="/admin/agent/checkuser.php" min="2" max="20" msg="用户名不得少于2个字符超过20个字符|"/>		</td>
    </tr>
	        <tr>
...
人民币&nbsp;<span class="r">*货币类型一旦设置无法修改，而且所有下级也按此货币类型结算。</span>
      ...
      <tr>
        ...
        <td>
<input boxid="auto" name="liveMoney" type="text" id="liveMoney" value="0" size="12" maxlength="12" require="true" datatype="double|range" min="0" max="100000000000000000" msg="真人点数限额最小为0|真人点数无最大限额" msgid="liveMoney1"/>
...
&nbsp;<font style="color:red">% / <span id="liveWash2">0.9</span>%</font>
