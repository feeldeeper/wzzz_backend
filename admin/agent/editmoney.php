...
<tr id="payIn">
    ...
    <td>
<input type="text" onclick="if(this.value == 0){this.value = ''}" id="payInMoney" onkeyup="pay()" name="payInMoney" value="0" size="12" require="true" datatype="currency|range" min="0" max="100000000000000" msg="真人点数限额最小为0|真人点数无上限" msgid="code1"/>
