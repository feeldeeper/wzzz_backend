...
$user = $user[0];
$agent = $database->query("select * from user where type =1");
...
<table cellpadding="0" cellspacing="1" class="table_list">
  <caption>
  <?=$user['username']?> 超级管理员 信息  </caption>
    <tr>
    ...
    <tr>
    	<td colspan="4">扩展功能：<span class="align_c">
          <input class="button_style" onclick="redirect('/admin/agent/add.php?type=magent&id=<?=$uid?>')" type='button' value='添加总代理' />
...
<form method="post" name="myform">
  <caption>
    ...
    <tr align="center">
        ...
        <th width="90">新建时间</th>
        <th width="200"><strong>管理操作</strong></th>
    </tr>
<tbody id="userList">
