...
$user = $database->query("select * from user where id = 1")->fetch();
$agent = $database->query("select * from user where type =1")->fetchAll();
...
<table cellpadding="0" cellspacing="1" class="table_list">
    ...
    <tr>
        <td colspan="4">扩展功能：<span class="align_c">
          <input class="button_style" onclick="redirect('/admin/agent/add.php?type=magent&id=<?= $uid ?>')"
                 type='button' value='添加总代理'/>
