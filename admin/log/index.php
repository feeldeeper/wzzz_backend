...
<script type="text/javaScript" src="/user/js/log.js"></script>
    ...
    <td><input type="text" name="s_fromdate" id="s_fromdate" value="" size="19" readonly>&nbsp;<script language="javascript" type="text/javascript">
					date = new Date();document.getElementById ("s_fromdate").value="<?php echo date("Y-m-d",strtotime("-1 day"))?> 08:00:00";
					Calendar.setup({
    ...
    <td><input type="text" name="s_todate" id="s_todate" value="" size="19" readonly>&nbsp;<script language="javascript" type="text/javascript">
					date = new Date();document.getElementById ("s_todate").value="<?php echo date("Y-m-d",time())?> 23:59:59";
					Calendar.setup({
						inputField     :    "s_todate",
						ifFormat       :    "%Y-%m-%d %H:%M:%S",
	showsTime      :    true,
	...
	<input type="submit" onClick="redirect('/admin/log/index.php')" value="清空条件">
	</td>
  </tr>
</table>
